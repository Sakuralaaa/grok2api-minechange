...
def default_quota_set(pool: str) -> AccountQuotaSet:
    ...
    if src.console is not None:
        qs.console = _w(src.console.remaining, src.console.total, src.console.window_seconds)
    return qs
...
def normalize_quota_set(pool: str, quota_set: AccountQuotaSet) -> AccountQuotaSet:
    ...
    qs.console = normalize_quota_window(pool, 5, quota_set.console)
    return qs
