...
MODELS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec("grok-4.20-reasoning-console",                ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Reasoning Console"),
    ModelSpec("grok-4.20-expert-console",                   ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Expert Console"),
    ModelSpec("grok-4.3-console",                           ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.3 Console"),
    ModelSpec("grok-4.3-beta-console",                      ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.3 Beta Console"),
    ModelSpec("grok-4.3-low-console",                       ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.3 Low Console"),
    ModelSpec("grok-4.3-medium-console",                    ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.3 Medium Console"),
    ModelSpec("grok-4.3-high-console",                      ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.3 High Console"),
    ModelSpec("grok-4.5-console",                           ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.5 Console (Experimental)"),
    ...
    ModelSpec("grok-4.20-heavy-console",                    ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Heavy Console"),
    ModelSpec("grok-4.20-multi-agent-0309-console",         ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Multi-Agent 0309 Console"),
    ModelSpec("grok-4.20-heavy-low-console",                ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Heavy Low Console"),
    ModelSpec("grok-4.20-heavy-medium-console",             ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Heavy Medium Console"),
    ModelSpec("grok-4.20-heavy-high-console",               ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Heavy High Console"),
    ModelSpec("grok-4.20-heavy-xhigh-console",              ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Heavy XHigh Console"),
    ModelSpec("grok-4.20-multi-agent-low-console",          ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Multi-Agent Low Console"),
    ModelSpec("grok-4.20-multi-agent-medium-console",       ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Multi-Agent Medium Console"),
    ModelSpec("grok-4.20-multi-agent-high-console",         ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Multi-Agent High Console"),
    ModelSpec("grok-4.20-multi-agent-xhigh-console",        ModeId.CONSOLE,  Tier.BASIC, Capability.CONSOLE_CHAT,       True, "Grok 4.20 Multi-Agent XHigh Console"),
