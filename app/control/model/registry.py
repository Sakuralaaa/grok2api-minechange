...
MODELS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec("grok-4.3-low-console",                   ModeId.GROK_4_3, Tier.SUPER, Capability.CHAT,       True, "Grok 4.3 Low Console"),
    ModelSpec("grok-4.3-medium-console",                ModeId.GROK_4_3, Tier.SUPER, Capability.CHAT,       True, "Grok 4.3 Medium Console"),
    ModelSpec("grok-4.3-high-console",                  ModeId.GROK_4_3, Tier.SUPER, Capability.CHAT,       True, "Grok 4.3 High Console"),
    ...
    ModelSpec("grok-4.20-heavy-low-console",            ModeId.HEAVY,    Tier.HEAVY, Capability.CHAT,       True, "Grok 4.20 Heavy Low Console"),
    ModelSpec("grok-4.20-heavy-medium-console",         ModeId.HEAVY,    Tier.HEAVY, Capability.CHAT,       True, "Grok 4.20 Heavy Medium Console"),
    ModelSpec("grok-4.20-heavy-high-console",           ModeId.HEAVY,    Tier.HEAVY, Capability.CHAT,       True, "Grok 4.20 Heavy High Console"),
    ModelSpec("grok-4.20-heavy-xhigh-console",          ModeId.HEAVY,    Tier.HEAVY, Capability.CHAT,       True, "Grok 4.20 Heavy XHigh Console"),
    ModelSpec("grok-4.20-multi-agent-low-console",      ModeId.HEAVY,    Tier.HEAVY, Capability.CHAT,       True, "Grok 4.20 Multi-Agent Low Console"),
    ModelSpec("grok-4.20-multi-agent-medium-console",   ModeId.HEAVY,    Tier.HEAVY, Capability.CHAT,       True, "Grok 4.20 Multi-Agent Medium Console"),
    ModelSpec("grok-4.20-multi-agent-high-console",     ModeId.HEAVY,    Tier.HEAVY, Capability.CHAT,       True, "Grok 4.20 Multi-Agent High Console"),
    ModelSpec("grok-4.20-multi-agent-xhigh-console",    ModeId.HEAVY,    Tier.HEAVY, Capability.CHAT,       True, "Grok 4.20 Multi-Agent XHigh Console"),
    # Super+
