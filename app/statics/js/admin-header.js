window.renderAdminHeader = async function renderAdminHeader() {
  ...
  const HEADER_HTML_CACHE_KEY = `grok2api.admin_header_html.${scriptVersion}.register`;
      ...
      <header class="admin-header">
        <div class="admin-header-inner">
          ...
          <nav class="admin-nav">
            ...
            <a href="/admin/register" class="admin-nav-link" data-nav="/admin/register" data-i18n="header.register">注册机</a>
          </nav>
