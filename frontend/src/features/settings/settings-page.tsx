    ...
    <form className="w-full space-y-8 [&_input]:border-transparent" onSubmit={form.handleSubmit((values) => updateMutation.mutate(values))}>
      ...
      {snapshot ? (
        <Tabs defaultValue="providers" className="space-y-6">
          ...
          <SettingsSection title={t("settings.console.title")}>
            <div className="grid gap-x-4 gap-y-5 sm:grid-cols-2">
              <SettingsField controlId="console-responses-url" className="sm:col-span-2" label={t("settings.console.responsesURL")} error={form.formState.errors.providerConsole?.responsesURL?.message}><Input id="console-responses-url" {...form.register("providerConsole.responsesURL")} /></SettingsField>
              <SettingsField controlId="console-cluster" className="sm:col-span-2" label={t("settings.console.cluster")} error={form.formState.errors.providerConsole?.cluster?.message}><Input id="console-cluster" {...form.register("providerConsole.cluster")} /></SettingsField>
              <SettingsField controlId="console-team-id" label={t("settings.console.teamId")} error={form.formState.errors.providerConsole?.teamId?.message}><Input id="console-team-id" {...form.register("providerConsole.teamId")} /></SettingsField>
              <SettingsField controlId="console-timeout" label={t("settings.console.timeoutSeconds")} error={form.formState.errors.providerConsole?.timeoutSeconds?.message}><Input id="console-timeout" type="number" min={30} max={3600} {...form.register("providerConsole.timeoutSeconds", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="console-user-agent" className="sm:col-span-2" label={t("settings.console.userAgent")} error={form.formState.errors.providerConsole?.userAgent?.message}><Input id="console-user-agent" {...form.register("providerConsole.userAgent")} /></SettingsField>
              <SettingsField controlId="console-quota-limit" label={t("settings.console.quotaLimit")} error={form.formState.errors.providerConsole?.quotaLimit?.message}><Input id="console-quota-limit" type="number" min={1} max={100000} {...form.register("providerConsole.quotaLimit", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="console-quota-window" label={t("settings.console.quotaWindowSeconds")} error={form.formState.errors.providerConsole?.quotaWindowSeconds?.message}><Input id="console-quota-window" type="number" min={60} max={604800} {...form.register("providerConsole.quotaWindowSeconds", { valueAsNumber: true })} /></SettingsField>
